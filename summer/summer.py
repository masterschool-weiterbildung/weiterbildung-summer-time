...
def value_generator() -> int:
    ...
    and yields each value until the cumulative sum exceeds LESS_THAN_ONE_THOUSAND.
...
def calculate_the_sum() -> int:
    ...
    Returns:
        int: The total sum of the values entered by the user until the sum exceeds LESS_THAN_ONE_THOUSAND.
    """
...
def main() -> None:
    """
    Main function that calculates and prints the final sum of user-entered values.
    """
